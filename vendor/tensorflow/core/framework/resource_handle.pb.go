...
func (*ResourceHandle) Descriptor() ([]byte, []int) { return fileDescriptor12, []int{0} }
...
func init() { proto.RegisterFile("tensorflow/core/framework/resource_handle.proto", fileDescriptor12) }
