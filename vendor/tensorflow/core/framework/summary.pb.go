...
func (*SummaryDescription) Descriptor() ([]byte, []int) { return fileDescriptor14, []int{0} }
...
func (*HistogramProto) Descriptor() ([]byte, []int) { return fileDescriptor14, []int{1} }
...
func (*Summary) Descriptor() ([]byte, []int) { return fileDescriptor14, []int{2} }
...
func (*Summary_Image) Descriptor() ([]byte, []int) { return fileDescriptor14, []int{2, 0} }
...
func (*Summary_Audio) Descriptor() ([]byte, []int) { return fileDescriptor14, []int{2, 1} }
...
func (*Summary_Value) Descriptor() ([]byte, []int) { return fileDescriptor14, []int{2, 2} }
...
func init() { proto.RegisterFile("tensorflow/core/framework/summary.proto", fileDescriptor14) }
