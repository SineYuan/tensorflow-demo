...
func (*TensorDescription) Descriptor() ([]byte, []int) { return fileDescriptor16, []int{0} }
...
func init() {
	proto.RegisterFile("tensorflow/core/framework/tensor_description.proto", fileDescriptor16)
}
