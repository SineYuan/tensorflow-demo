...
func (*TensorProto) Descriptor() ([]byte, []int) { return fileDescriptor15, []int{0} }
...
func init() { proto.RegisterFile("tensorflow/core/framework/tensor.proto", fileDescriptor15) }
